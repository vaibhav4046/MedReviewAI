...
MedReviewAI is built by the following team members:

- [Vaibhav Lalwani](https://github.com/vaibhav4046) — Lead engineer, full-stack, backend extraction pipeline, JWT auth, Vercel deploy
- [Pranjali Shelke](https://github.com/PranjaliShelke) — Frontend UI, dashboard, results viewer
- [Durgesh](https://github.com/durgesh432003) — Search aggregator, multi-source integration
